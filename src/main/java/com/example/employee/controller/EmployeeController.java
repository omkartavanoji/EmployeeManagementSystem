...
public class EmployeeController {
	...
	@PutMapping("updatetask-status/{id}-{status}")
	public ResponseEntity<Object> updateTaskStatus(@PathVariable int id, @PathVariable String status,Principal principal) {
		return employeeService.updateTaskStatus(id, status,principal);
	}
}
